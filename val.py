...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/pests.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp40/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--save-hybrid', default=True, action='store_true', help='save label+prediction hybrid results to *.txt')
    ...
    opt.save_json |= opt.data.endswith('pests.yaml')
