...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/exp32/weights/best.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='yolov5m.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/my_pests.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.scratch-low.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=400)
    parser.add_argument('--batch-size', type=int, default=108, help='total batch size for all GPUs, -1 for autobatch')
...
def main(opt, callbacks=Callbacks()):
    ...
    # Evolve hyperparameters (optional)
        ...
        meta = {
            ...
            'warmup_epochs': (10, 0.0, 5.0),  # warmup epochs (fractions ok)
